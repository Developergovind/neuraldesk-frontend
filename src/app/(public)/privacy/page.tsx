        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-coral-400">1. Information We Collect</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-coral-400">2. How We Use Your Information</h2>
              <p className="text-white/70 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-coral-400">3. Data Security</h2>
              <p className="text-white/70 leading-relaxed">
