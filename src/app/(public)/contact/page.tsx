...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isDisposableEmail(email)) {
      return toast.error("Temporary and disposable email addresses are not accepted.", {
        duration: 5000,
        icon: "🚫",
      });
    }
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/50 transition-all"
