        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-blush-400">1. Acceptance of Terms</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-blush-400">2. Description of Service</h2>
              <p className="text-white/70 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-heading font-bold mb-4 text-blush-400">3. User Responsibilities</h2>
              <p className="text-white/70 leading-relaxed">
